/**
 * HappyBot — Embeddable Chat Widget
...
(function () {
  'use strict';
  if (window.__happybot_loaded) return;
  window.__happybot_loaded = true;
  ...
  var customerName = window.happybot_customer_name || scriptEl.getAttribute('data-customer-name') || '';
  var customerEmail = window.happybot_customer_email || scriptEl.getAttribute('data-customer-email') || '';
  var customerPhone = window.happybot_customer_phone || scriptEl.getAttribute('data-customer-phone') || '';
  var customerAvatar = window.happybot_customer_avatar || scriptEl.getAttribute('data-customer-avatar') || '';
  ...
  try {
    ...
    console.warn('HappyBot Auto-Discovery status:', discoveryError);
  }

  // --- สร้าง Container หลัก ---
  var container = document.createElement('div');
  container.id = 'happybot-widget';
  ...
  style.textContent = [
    '#happybot-widget *{box-sizing:border-box;margin:0;padding:0}',
  ...
  function openChat() {
    ...
    fab.innerHTML = '<svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="#0d0d0d" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>';
  }
